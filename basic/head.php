    ...
    <div id="hd_wrapper" class="clearfix">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>">
                <img src="<? echo G5_THEME_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
...
<div id="subBg">
    <div id="page_title" class="sbtImg ">
        <div class="title">
            <img src="" alt="">
            <h2 class="loc1D" style="opacity:0"><!-- 1차메뉴 --></h2>
            <div class="text"></div>
        </div>
    </div>
</div>
<script>
   ...
   window.onload = function(){
    ...
    if(menuDep == "ABOUT"){
        $("#subBg .text").text("시 코 르 를 놓 칠 수 없 는 네 가 지 이 유");
    ...
    if(menuDep == "STORES"){
        $("#subBg .text").text("현 재 영 업 중 인 시 코 르 매 장 안 내");
    ...
    if(menuDep == "BRAND"){
        $("#subBg .text").text("신 세 계 에 서 오 픈 한 토 탈 뷰 티 스 토 어");
     ...
     if(menuDep == "NEWS"){
        $("#subBg .text").text("시 코 르 가   알 려 주 는   최 신 소 식");
