            ...
            <td class="td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                ...
                <?php } ?>
                 ...
                 <?php
                        ...
                        if($thumb['src']) {
                            $img_content = '<img src="'.$thumb['src'].'" alt="'.$thumb['alt'].'" class="bx-image">';
                        } else {
                ...
                <div class="bo_tit">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>">
                        ...
                        <?php
                         ...
                         ?>
                       <h3 style="font-size:1.5em;line-height:1.5em; color:#000"> <?php echo $list[$i]['subject'] ?></h3>
                        </a>

                        <?php echo cut_str( $list[$i]['wr_content'],150) ?>
