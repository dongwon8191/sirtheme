...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/colorbox.css">', 0);
?>

<script src="<? echo $board_skin_url ?>/js/jquery.colorbox-min.js"></script>
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <li class="<?php echo implode(' ', $classes); ?>">
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img">
                      <a href="<?php echo $list[$i]['link'][1] ?>" class="bo_tit youtube">  
                        <?php
                    ...
                    <div class="gall_text_href">
                        ...
                        <? if($admin_href){?>}
                             ...
                             <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">[글보기]</a>
