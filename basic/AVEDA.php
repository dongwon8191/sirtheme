...
<div class="dear02">
	<div class="head" style="position:relative;">
     ...
     >AVEDA(아베다)</h1>
		<p style="
            ...
            left: 50%;
            text-align: center;
		">몸과 마음의 웰빙을 추구하는 토탈 라이프스타일 브랜드</p>
		<img src="<?echo G5_THEME_IMG_URL?>/av.jpg" alt=""
		 style="width:1900px">
	...
	<div class="contentbox02" style="width:1900px; height: 710px; background-color:#fff; position: relative;">
		<h3 style=" font-size: 28px; position: absolute; top: 50px; left: 250px;"
         >Brand Best Item</h3>
   
  
		<img src="<?echo G5_THEME_IMG_URL?>/av1.jpg" alt="" style=" padding-left:200px; padding-top: 150px;  ">
