...
<div class="dear03">
	<div class="head" style="position:relative;">
     ...
     >shu uemura(슈에무라)</h1>
		<p style="
            ...
            left: 50%;
            text-align: center;
		">"아름다운 메이크업은 아름다운 피부에서 시작한다"는 철학에 기반하여 예술적인 메이크업 표현을 위한 혁신적인 스킨케어, <br>다채로운 컬러를 선보이는 프로페셔널 메이크업 아티스트 브랜드

</p>
		<img src="<?echo G5_THEME_IMG_URL?>/su.jpg" alt="" style="width:1900px">
	...
	<div class="contentbox03" style="width:1900px; height: 710px; background-color:#fff; position: relative;">
		...
		<img src="<?echo G5_THEME_IMG_URL?>/su1.jpg" alt="" style=" padding-left:200px; padding-top: 150px;  ">
